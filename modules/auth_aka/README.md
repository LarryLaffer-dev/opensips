...
```opensips title="aka_www_authorize usage"
...
The function behaves the same as [aka_www_authorize()](#aka_www_authorizerealm),
...
```opensips title="aka_proxy_authorize usage"
...
[default_av_mgm](#default_av_mgm-string) is being used.
...
[default_qop](#default_qop-string) is being used.
...
the value of the [default_algorithm](#default_algorithm-string) is being used.
...
```opensips title="aka_www_challenge usage"
...
...
The function behaves the same as [aka_www_challenge()](#aka_www_challengeav_mgm-realm-qop-alg),
...
```opensips title="aka_proxy_challenge usage"
...
```opensips title="aka_av_drop_all usage"
...
```opensips title="aka_av_fail usage"
...
...
```bash title="auth_aka:av_add usage"
...
## adds an AKA AV
...
```bash title="auth_aka:av_drop_all usage"
...
## adds an AKA AV
