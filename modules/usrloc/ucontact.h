...
/*! \brief
 * Serialize a Contact URI parameter list into "name=value;flag;..." form.
 *
 * On success, @dst holds a pkg-allocated, NUL-terminated buffer owned by the
 * caller. An empty list is not an error and yields an empty @dst.
 *
